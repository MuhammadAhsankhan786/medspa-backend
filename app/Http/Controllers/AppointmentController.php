...
class AppointmentController extends Controller
{
    ...
    {
        $user = Auth::user();
        $query = Appointment::with(['client.clientUser', 'staff', 'location', 'service', 'package']);
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            ...
            'appointment' => $appointment->load(['client.clientUser', 'staff', 'location', 'service', 'package'])
        ], 201);
    }
    ...
    public function show(Appointment $appointment)
    {
        ...
        return response()->json($appointment->load(['client.clientUser', 'staff', 'location', 'service', 'package']));
    }
    ...
    public function myAppointments(Request $request)
    {
        ...
        $query = Appointment::with(['staff', 'location', 'service', 'package'])
